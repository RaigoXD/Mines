...
class Buscaminas:
    ...
    def generar_tabla(self):
        ...
        """
        matriz = np.zeros(
            (self.longitudes, self.longitudes), dtype=int
        )  # Defino el Tablero.
        return matriz
            ...
            for columnas in range(self.longitudes):
                if matriz[filas][columnas] != 9:
                    ...
                    if (
                        filas - 1 >= 0
                        and columnas - 1 >= 0
                        and matriz[filas - 1][columnas - 1] == 9
                    ):  # Verifico Arriba a la izquierda
                        matriz[filas][columnas] += 1

                    if (
                        filas - 1 >= 0 and matriz[filas - 1][columnas] == 9
                    ):  # Verifico Arriba
                        matriz[filas][columnas] += 1

                    if (
                        filas - 1 >= 0
                        and columnas + 1 < self.longitudes
                        and matriz[filas - 1][columnas + 1] == 9
                    ):  # Verifico arriba a la derecha
                        matriz[filas][columnas] += 1

                    if (
                        columnas - 1 >= 0 and matriz[filas][columnas - 1] == 9
                    ):  # Verifico a la izquieda
                        matriz[filas][columnas] += 1

                    if (
                        columnas + 1 < self.longitudes
                        and matriz[filas][columnas + 1] == 9
                    ):  # Verifico a la derecha
                        matriz[filas][columnas] += 1

                    if (
                        filas + 1 < self.longitudes
                        and columnas - 1 >= 0
                        and matriz[filas + 1][columnas - 1] == 9
                    ):  # Verifico abajo a la izquierda
                        matriz[filas][columnas] += 1

                    if (
                        filas + 1 < self.longitudes and matriz[filas + 1][columnas] == 9
                    ):  # Verifico abajo
                        matriz[filas][columnas] += 1
    ...
    def generar_minas(self, matriz, fila, columa):
        ...
        while contador_minas < self.nro_minas:
            ...
            if (
                random_columna != columa
                and random_fila != fila
                and (abs(fila - random_fila) >= 2 or abs(columa - random_columna) >= 2)
            ):  # se busca que la posicion del primer click este vacia y su alrededor
